  ...
  public void start() {
    ...
    while(true) {
      System.out.println("Click in the Console,"
          ...
          + "\n S (then Enter) to Search all phone book entries,"
      ...
      if(command.charAt(0) == 'A') {
       ...
       System.out.println("Please choose your search scope:\n"
                           + "1: Search by Name (First, Last, or both)\n"
                           + "2: Search by Phone number");
       String selection = in.nextLine();
       if(selection.charAt(0) == '1') {
         System.out.println("Enter name:");
         String name = in.nextLine();
         database.searchName(name);
       }
       if(selection.charAt(0) == '2') {
         System.out.println("Enter phone number:");
         String phone = in.nextLine();
         database.searchPhone(phone);
       }
      }
        ...
        System.out.println("Invalid command. Please enter either A, D, S, K, or Q.");
      }
      else {
        System.out.println("Bye");
        database.close(true);
