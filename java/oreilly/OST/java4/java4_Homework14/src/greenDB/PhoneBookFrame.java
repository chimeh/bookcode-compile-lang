    ...
    class GetListener implements ActionListener {  // Gets the entries from the text fields
       ...
       */
        ...
        public String buildQuery(String last, String first, String ac, String pre, String sfx) {
            ...
            if(first.equals("*") || last.equals("*") || ac.equals("*") || pre.equals("*") || sfx.equals("*")) {
              return "select * from Listings";
            }

            return "select PRI_KEY, LAST_NAME, FIRST_NAME, AREA_CODE, PREFIX, SUFFIX from Listings" + whereClause;
        }
