...
public class OneDArrayApplet extends Applet {
  ...
  private Color[] boxColors = {Color.blue, Color.red, Color.green, Color.cyan, Color.magenta, Color.yellow};
  
  private Button resetColors = new Button("Reset Colors");
  public void init() {
    for(int i = 0; i <boxes.length; i++) {
      boxes[i] = new ClickableBox(START_X, START_Y + i * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT, Color.black, Color.red, true, this);
