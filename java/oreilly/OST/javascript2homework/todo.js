...
function saveTodoData(){
  ...
  request.onreadystatechange = function(){
	  if(this.status == 200){
	    console.log("Request received a good response: " + this.status);
	  }
	  else if(this.status == 404){
	    console.log("File you were looking for was not found: " + this.status)
	  }
	  else if(this.status == 500){
	    console.log("Uh oh, server error: " + this.status);
	  }
    };
