...
public class Rectangle extends Shape implements ComparableShape {
	 ...
	 */
	public Rectangle(int x, int y, int w, int h, Color lineColor,
	...
	/*
	 * Method to check if coordinates are in Rectangle object.
	 */
	...
	/*
	 * String value of Rectangle object.
	 */
