...
public class MyApplicationRunner implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		for (int i = 0; i < 10; i++) {
			...
			// Gateway sends 10 messages to Direct Channel...
			// there are 2 consumers (subscribers) but Direct Channel only delivers to 1 consumer at a time.
			// Direct Channel uses round-robin strategy to deliver messages to subscribed consumers.
