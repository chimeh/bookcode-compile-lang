...
public class ClickableBox extends MouseAdapter {
	...
	public ClickableBox(int x, int y, int width, int height, Color borderColor, Color backColor, boolean drawBorder, Container parent, String boardChar) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public void setBoardChar(String c) {
		this.boardChar = c;
	}
